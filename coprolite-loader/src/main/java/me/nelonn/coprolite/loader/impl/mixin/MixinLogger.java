...
import me.nelonn.coprolite.loader.impl.log.LogLevel;
...
public final class MixinLogger extends LoggerAdapterAbstract {
	...
	public void log(Level level, String message, Object... params) {
		LogLevel coproliteLevel = translateLevel(level);
		if (!Log.shouldLog(coproliteLevel, logCategory)) return;
		...
		Log.log(coproliteLevel, logCategory, message, exc);
	}
