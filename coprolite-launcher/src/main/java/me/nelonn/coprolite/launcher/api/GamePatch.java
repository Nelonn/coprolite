...
package me.nelonn.coprolite.launcher.api;
...
public abstract class GamePatch {
    ...
    public abstract void process(CoproliteLauncher launcher, Function<String, ClassReader> classSource, Consumer<ClassNode> classEmitter);
}
